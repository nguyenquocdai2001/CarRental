									...
									<div class="col-md-6 pr-1">
										<div class="form-group">
											<label>Tên doanh nghiệp</label> <input type="text"
												...
												value="${bill.name_agency}" name="name_agency" readonly>
										</div>
									</div>
									...
									<div class="col-md-6 pr-1">
										<div class="form-group">
											<label>Hình thức thanh toán</label> <select class="form-control"
												readonly name="payment" id="payment">
									...
									<div class="col-md-6 pr-1">
										<div class="form-group">
											<label>Đơn giá trước chiết khấu</label> <input type="number"
												...
												name="price_bf_discount" readonly>
										</div>
									</div>
									<div class="col-md-6 pr-1">
										<div class="form-group">
									...
									<div class="col-md-6 pr-1">
										<div class="form-group">
											<label>Thành tiền trước thuế</label> <input type="number"
												class="form-control"
												placeholder="Nhập thành tiền trước thuế" name="price_bf_tax" value="${bill.price_bf_tax}" readonly>
										</div>
									</div>
									...
									<div class="col-md-6 pr-1">
										<div class="form-group">
											<label>Tổng tiền thanh toán</label> <input type="number"
												class="form-control"
												placeholder="Nhập tổng tiền thanh toán" name="total_price" value="${bill.total_price}" readonly>
										</div>
									</div>
								</div>
